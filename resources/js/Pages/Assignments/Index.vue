<template>
    ...
    <AuthenticatedLayout>
        ...
        <div class="space-y-6">
            ...
            <div v-if="is_staff_outside_aos" class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div v-for="assignment in assignments.data" :key="assignment.id" class="bg-white rounded-2xl p-6 shadow-sm border border-gray-150 space-y-6 hover:shadow-md transition duration-200 flex flex-col justify-between">
                    <div class="space-y-4">
                        ...
                        <!-- Technical Meta fields (Due Date / Status) -->
                        <div class="grid grid-cols-2 gap-4 py-3 border-y border-gray-50 text-xs">
                            <div>
                            ...
                            <div>
                                ...
                                <span class="px-2.5 py-0.5 rounded-full inline-block font-bold capitalize mt-0.5 text-[10px]"
                                    :class="{
