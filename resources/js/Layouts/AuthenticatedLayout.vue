    ...
    <div class="h-screen bg-gray-50 flex overflow-hidden relative">
        ...
        <aside :class="[
            ...
            <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
                ...
                <Link v-if="['ict_administrator', 'executive_director'].some(r => $page.props.auth.roles.includes(r))" :href="route('admin.settings.index')" :class="navClass('admin.settings.*')" title="System Settings">
